...
int main() {
  ...
  std::cout << Facade::getInstance()->seleccionarPokemon("Pikachu", "Hugo")
            << endl;
...
//             Facade::getInstance()->unirBatalla(nombreUsuario);
...
//
//             std::string respuesta = Facade::getInstance()->iniciarBatalla(new
//             GeneradorAleatorio()); event.reply(respuesta);
//         }
//     });
//
//    // COMANDO MENU ATAQUE
...
//             event.reply("Error: El parámetro proporcionado no es un string
//             válido.");
//         }
//     }
// });;
...
//             event.reply(Facade::getInstance()->atacar(nombreUsuario,
//             nombreMov));
//         } catch (const std::bad_variant_access& e) {
//             event.reply("Error: El parámetro proporcionado no es un string
//             válido.");
...
//         dpp::slashcommand llamar("llamar", "Selecciona un Pokémon",
//         bot.me.id); llamar.add_option(
//             dpp::command_option(dpp::co_string, "nombre", "Nombre del
//             Pokémon", true) // Parámetro obligatorio
//         );
//
// 	    dpp::slashcommand batalla("batalla", "Inicia la batalla!",
// bot.me.id);
//
//         dpp::slashcommand pokedex("pokedex", "Desplegar pokemones
//         disponibles", bot.me.id);
//
// 	    dpp::slashcommand menu_ataque("menu_ataque", "Desplegar el menú de
// ataque!", bot.me.id);
//
//         dpp::slashcommand atacar("atacar", "Ejecuta un ataque", bot.me.id);
//         atacar.add_option(
//             dpp::command_option(dpp::co_string, "ataque", "Nombre del
//             ataque", true) // Parámetro obligatorio
//         );
//
...
//                         callback.get<dpp::slashcommand>().name << std::endl;
//                     }
//                 }
//             );
//         }
