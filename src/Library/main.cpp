...
int main() {
  ...
  //             << endl;
  //   std::cout << Facade::getInstance()->seleccionarPokemon("Charizard",
  //   "Chorro")
  //             << endl;
  //   std::cout << Facade::getInstance()->desplegarMenuAtaque("Hugo") <<
  //   std::endl; std::cout << Facade::getInstance()->atacar("Hugo", "Rayo") <<
  //   endl; std::cout << Facade::getInstance()->desplegarMenuAtaque("Chorro")
  //             << std::endl;
  //   std::cout << Facade::getInstance()->atacar("Chorro", "Lanzallamas") <<
  //   endl;
  // }
