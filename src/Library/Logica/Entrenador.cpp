...
int Entrenador::getContadorEspecial() const { return contadorEspecial; }

vector<IItem *> Entrenador::getItems() const { return items; }
...
void Entrenador::agregarItem(IItem *item) { items.push_back(item); }
